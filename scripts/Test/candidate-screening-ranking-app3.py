...
def calculate_similarity(job_description, df):
    ...
    return df_sorted[['Original_Index', 'ID', 'Resume_str', 'Rank']].head(10)

# Streamlit app
def main():
    # Center the title with images
    st.markdown(
        """
        <div style="text-align: center;">
            <h1>Candidate Screening and Ranking</h1>
            <img src="https://via.placeholder.com/150" alt="App Image 1" style="margin: 10px;">
            <img src="https://via.placeholder.com/150" alt="App Image 2" style="margin: 10px;">
        </div>
        """,
        ...
        if st.button("Match Resumes 🔍"):
            if job_description.strip() == "":
                ...
                if not top_matches.empty:
                    ...
                    # Apply CSS to center align the numbers in Rank and ID columns
                    st.markdown(
                        """
                        <style>
